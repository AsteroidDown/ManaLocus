      ...
      <View className="flex flex-1 gap-4 lg:px-48 px-4 py-8 min-h-fit bg-dark-100">
        <View className="flex gap-4 min-h-fit">
          ...
          <Text>
            ...
            affiliate companies ("ManaLocus," "we," "us," and "our") apply to
            all contents and information available within the domain
            manalocus.com. Please read the following terms and conditions
            ("Terms of Service" or "Agreement") carefully before using the Site.
          </Text>
          ...
          <Text>
            ...
            with any additional guidelines or rules that may be posted on the
          ...
          <Text>
            ...
            other countries. © 1993-{moment().format("yyyy")} Wizards. All
            Rights Reserved.
          </Text>
          ...
          <View className="flex gap-2 ml-4">
            <View className="flex flex-row gap-4">
              ...
              <Text className="mt-px">
                ...
                LLC, a subsidiary of Hasbro, Inc. All card images, logos, and
            ...
            <View className="flex flex-row gap-4">
              ...
              <Text className="mt-px">
                ...
                Magic: The Gathering in any way that is commercial or could
                cause confusion with the official Magic: The Gathering brand.
              </Text>
            </View>
            ...
            <View className="flex flex-row gap-4">
              ...
              <Text className="mt-px">
                ...
                distribute, or otherwise use this content for commercial
                purposes without express written permission from ManaLocus.
              </Text>
            </View>
          </View>
          ...
          <Text>
            ...
            otherwise exploited for any purpose without the express prior
            written consent of ManaLocus.
          </Text>
          ...
          <Text>
            You agree to use the Site in a manner that is lawful and respectful
            of others. Specifically, you agree not to:
          </Text>
          ...
          <View className="flex gap-2 ml-4">
            <View className="flex flex-row gap-4">
              <View className="w-1.5 h-1.5 mt-2 rounded-full bg-white" />
              <Text className="mt-px">
                Engage in any activity that infringes on the intellectual
                property rights of others, including but not limited to,
                copying, distributing, or displaying copyrighted material
            ...
            <View className="flex flex-row gap-4">
              ...
              <Text className="mt-px">
                ...
                harmful, defamatory, abusive, or otherwise inappropriate.
              </Text>
            </View>
            ...
            <View className="flex flex-row gap-4">
              <View className="w-1.5 h-1.5 mt-2 rounded-full bg-white" />
              <Text className="mt-px">
                Use the Site for commercial purposes without prior written
                consent from ManaLocus.
              </Text>
            </View>
            ...
            <View className="flex flex-row gap-4">
              <View className="w-1.5 h-1.5 mt-2 rounded-full bg-white" />
              <Text className="mt-px">
                Impersonate any individual or entity or falsely state or
                otherwise misrepresent your affiliation with any individual or
                entity.
              </Text>
            </View>
          ...
          <Text>
            ...
            account termination. If you would like to appeal one of our
            decisions, please send an email to{" "}
            <Link
          ...
          <View className="flex gap-2 ml-4">
            ...
            <View className="flex flex-row gap-4">
              <View className="w-1.5 h-1.5 mt-2 rounded-full bg-white" />
              <Text className="mt-px">
                Respect the privacy and security of others. Do not share
          ...
          <Text>
            The Site may contain links to third-party websites, including but
            not limited to online stores or external content related to Magic:
            The Gathering. These links are provided for your convenience, but
          ...
          <Text>
            ...
            security of the Site, including, without limitation, by (a)
            accessing data not intended for such user or logging onto a server
            or an account which the user is not authorized to access; (b)
            ...
            proper authorization; (c) accessing or using the Site or any portion
            thereof without authorization; or (d) introducing any viruses,
          ...
          <View className="flex gap-2 ml-4">
            ...
            <View className="flex flex-row gap-4">
              ...
              <Text className="mt-px">
                ...
                or enjoyment of the Site, or which, as determined by us, may
                harm us or users of the Site or expose them to liability;
              </Text>
            </View>
          ...
          <Text>
            ...
            information. By using the Site, you agree to the terms of our
            Privacy Policy.
          </Text>
          ...
          <Text>
            The content and services provided on ManaLocus are offered "as is"
            and "as available," without any warranty or representation, express
            or implied. We do not guarantee that the Site will be free of
            errors, viruses, or other harmful components. You agree to use the
          ...
          <Text>
            To the fullest extent permitted by applicable law, ManaLocus shall
          ...
          <Text>
            ...
            maximum liability to you with respect to your use of this Site and
            any products or services purchased by you through the Site is one
            hundred dollars ($100.00). The foregoing limitations apply even if
            the remedies under these terms of use fail of their essential
            purpose.
          </Text>

          <Text>
            Any claims arising in connection with your use of the Site or any
            products or services purchased through the Site must be brought
            within one (1) year of the date of the event giving rise to such
            action occurred.
          </Text>
          ...
          <Text>
            ...
            employees, agents, and licensors from any claims, liabilities,
          ...
          <Text>
            ...
            Service at any time, with or without notice. Changes will be
            effective immediately upon posting on the Site, and your continued
            use of the Site after such changes constitutes your acceptance of
            the revised Terms. We encourage you to return to this webpage
            frequently so that you are aware of our current Terms.
          </Text>
          ...
          <Text>
            ...
            jurisdiction of the courts in Ontario.
          </Text>
          ...
          <Text>
            ...
            your account and any contents generated by you on the Site, block
            your access to the Site, block IP addresses.
          </Text>
