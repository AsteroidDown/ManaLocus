    ...
    >
      <View className="flex gap-4 min-h-fit">
        ...
        <Text>
          ...
          your privacy and ensuring a safe online experience for all our users.
        ...
        <Text>
          ...
          information to or through the Site, you consent to the collection and
          processing of your information as described in this Privacy Policy. By
          using the Site, you accept the terms of this Privacy Policy and our
          Terms of Use, and consent to our collection, use, disclosure and
          retention of your information as described in this Privacy Policy. We,
          and our Site visitors, are bound by laws in the United States. If you
          do not agree with any part of this Privacy Policy, you are not
        ...
        <Text>
          ...
          or indirectly. This may include, but is not limited to:
        </Text>
          ...
          <View className="flex flex-row gap-4">
            ...
            <Text weight="semi" className="mt-px">
              ...
              <Text>
                ...
                enhance the functionality of the Site, and ensure it runs
                smoothly.
              </Text>
            </Text>
          </View>
          ...
          <View className="flex flex-row gap-4">
            ...
            <Text weight="semi" className="mt-px">
              ...
              <Text>
                ...
                or important notices about the Site. You may opt-out of these
          ...
          <View className="flex flex-row gap-4">
            ...
            <Text weight="semi" className="mt-px">
              ...
              <Text>
                ...
                the Site and to improve our content, features, and overall user
                experience.
              </Text>
            </Text>
          </View>
          ...
          <View className="flex flex-row gap-4">
            ...
            <Text weight="semi" className="mt-px">
              ...
              <Text>
                ...
                comply with applicable legal processes, respond to legal claims,
          ...
          <View className="flex flex-row gap-4">
            ...
            <Text weight="semi" className="mt-px">
              ...
              <Text>
                ...
                that help us operate and improve the Site (e.g., hosting
                providers, email marketing platforms). These service providers
                are required to protect your information and only use it for the
                purposes of providing their services.
              </Text>
            </Text>
          </View>
        ...
        <Text>
          ...
          delete your account or request that we no longer use your information,
        ...
        <Text>
          Our Site may contain links to external websites that are not operated
        ...
        <Text>
          ...
          information as soon as possible. If you believe we have inadvertently
        ...
        <Text>
          ...
          Canada or other countries where our servers are located. By using the
          Site, you consent to the transfer of your information to countries
